...
Синхронное и асинхронное соединения имеют общий метод `get_connection()`, который возвращает объект соединения.
Реализации соединений представлены в модуле **redis_connection.py** директории **storage/redis**.
